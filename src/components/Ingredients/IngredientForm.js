...
const IngredientForm = React.memo(props => {
  ...
  const [enteredTitle, setEnteredTitle] = useState(''); //can be anything - object or array or anything
        ...
        <form onSubmit={submitHandler}>
          <div className="form-control">
            ...
            <input type="text" id="title" value={enteredTitle} 
              ...
              //   setEnteredTitle(prevInputState=>({title: newTitle, amount: prevInputState.amount}))}
              // }
